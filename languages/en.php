...
return array(
	...
	'activity_tabs:configure' => "Configure Activity Tabs",
	'activity_tabs:enabled' => "Enabled",
	'activity_tabs:group' => "Group",
	'activity_tabs:group:display' => "Activity Options",
	'activity_tabs:groups' => "Groups",
	'activity_tabs:invalid:id' => "Invalid ID",
	'activity_tabs:name' => "Name",
	'activity_tabs:option:group_display:global' => "All activity by members of the group",
	'activity_tabs:option:group_display:group' => "Only activity within the group",
